...
export default function EmbedChat({ contextConfig, placeholder }: EmbedChatProps) {
    const {
        messages,
        inputValue,
        setInputValue,
        ...
        scrollContainerRef,
        handleScroll
    } = useQuantumChat('embed', contextConfig);
                ...
                <div className="max-w-3xl mx-auto w-full relative group">
                    ...
                    <div className="relative flex items-end gap-2 bg-card/80 backdrop-blur-xl border border-border rounded-2xl shadow-lg p-2 transition-all focus-within:ring-1 focus-within:ring-ring focus-within:border-ring focus-within:bg-card">
                        <textarea
                            ...
                            placeholder={placeholder || "Ask the Quantum Assistant..."}
                            rows={1}
