                    ...
                    <table className="w-full text-left text-sm text-[#0F172A]">
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {loading ? (
                                ...
                                filtered.map((exp) => (
                                    <tr key={exp._id} className="hover:bg-white transition-colors group">
                                        <td className="px-6 py-4">
                                            ...
                                            <div className="text-[10px] text-[#0F172A] mt-0.5 flex items-center gap-1.5">
                                                ...
                                                <span className={`px-1.5 py-0.5 rounded-full text-[8px] font-bold ${exp.source === 'API' ? 'bg-purple-50 text-purple-600 border border-purple-100' : 'bg-white text-[#0F172A] border border-[rgb(27,176,206)]/20'}`}>
                                                    {exp.source || 'Web'}
                                                </span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className="text-[10px] font-mono bg-white px-1.5 py-0.5 rounded border border-[rgb(27,176,206)]/30 text-[#0F172A]">
                                                {exp.userId || "Guest"}
                                            </span>
                                        </td>
                                        <td className="px-6 py-4">
