                                    ...
                                    <tr key={user._id} className="hover:bg-white transition-colors group">
                                        ...
                                        <td className="px-5 py-4">
                                            {user.role === 'admin' ? (
                                                ...
                                                <span className="px-2 py-0.5 bg-emerald-50 text-emerald-600 rounded text-[10px] font-bold border border-emerald-100">Student</span>
                                            ) : user.isApproved ? (
                                            ...
                                            <div className="flex justify-end gap-3 items-center">
                                                {user.role !== 'admin' && (
                                                    <button
                                                        ...
                                                        className={`text-xs font-semibold ${user.isApproved ? 'text-[#0F172A] hover:text-red-500' : 'text-[#0F172A] hover:underline'}`}
                                                    >
                    ...
                    <div className="bg-white w-full max-w-md rounded-2xl border border-[rgb(27,176,206)]/30 shadow-xl p-6 relative animate-in zoom-in-95 duration-200">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="pt-4 flex justify-end gap-3">
                                ...
                                <button onClick={handleAddUser} disabled={actionLoading} className="px-6 py-2 bg-[rgb(48,102,187)] hover:bg-[#255299] text-white rounded-xl text-sm font-semibold shadow-sm disabled:opacity-50">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="pt-6 flex justify-end gap-3">
                                ...
                                <button
                                    ...
                                    className="px-8 py-2.5 bg-[rgb(48,102,187)] hover:bg-[#255299] text-white rounded-xl text-sm font-semibold shadow-sm disabled:opacity-50"
                                >
