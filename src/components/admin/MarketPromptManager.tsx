                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                        ...
                        <input
                            ...
                            className="w-full p-3 bg-white border border-[rgb(27,176,206)]/30 rounded-xl focus:ring-1 focus:ring-[rgb(27,176,206)] outline-none text-sm text-[#0F172A]"
                            value={label}
                ...
                <table className="w-full text-left text-sm text-[#0F172A]">
                    ...
                    <tbody className="divide-y divide-slate-100">
                        {loading ? (
                            ...
                            prompts.map(prompt => (
                                <tr key={prompt._id} className={`group transition-colors ${prompt.isActive ? 'hover:bg-white' : 'bg-white/30 opacity-70'}`}>
                                    ...
                                    <td className="px-5 py-4">
                                        <button 
                                            ...
                                            className={`text-[10px] font-bold px-2 py-0.5 rounded-full border transition-all ${prompt.isActive ? 'bg-green-50 text-green-600 border-green-200' : 'bg-white text-[#0F172A] border-[rgb(27,176,206)]/30'}`}
                                        >
