...
export default function AdminNavbar({ setIsMobileMenuOpen, setShowPasswordModal }: AdminNavbarProps) {
    ...
    return (
        <header className="bg-transparent border-b h-16 flex items-center justify-between px-4 md:px-8 flex-shrink-0 z-30 transition-all duration-300 border-slate-100">
