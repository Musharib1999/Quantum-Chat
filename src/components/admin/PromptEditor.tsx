...
export default function PromptEditor() {
    ...
    if (prompts.length === 0) {
        return (
            <div className="p-8 text-center rounded-lg border border-[#3066bb]/30 text-slate-500 bg-white">
    ...
    return (
        <div className="border rounded-xl overflow-hidden shadow-sm bg-white border-[#3066bb]/30">
            <div className="p-6 border-b flex justify-between items-center sm:flex-row flex-col gap-4 border-[#3066bb]/20">
                <div>
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                    <select
                        className="text-sm rounded-lg border block w-full sm:w-64 p-2.5 outline-none bg-[#3066bb]/5 border-[#3066bb]/30 text-slate-900 focus:border-[#3066bb]"
            ...
            <div className="flex flex-col md:flex-row h-full md:h-[600px] divide-y md:divide-y-0 md:divide-x divide-slate-100">
                {/* Left Panel: Editor */}
                <div className="flex-1 flex flex-col p-6 relative bg-[#3066bb]/5/50">
                    ...
                    <textarea
                        className="flex-1 w-full border rounded-lg p-4 font-mono text-sm leading-relaxed resize-none focus:outline-none focus:border-[#3066bb] transition-colors scrollbar-thin bg-white border-[#3066bb]/30 text-slate-700 scrollbar-thumb-slate-300"
                    ...
                    <div className="mt-4 flex justify-end">
                        <button
                            ...
                            className={`flex items-center gap-2 px-5 py-2.5 rounded text-sm font-medium transition-all ${currentTemplate === activePrompt?.template
                                    ? 'bg-[#3066bb]/10 text-slate-400 cursor-not-allowed'
                ...
                <div className="w-full md:w-80 p-6 flex flex-col bg-white">
                    ...
                    <div className="space-y-3 overflow-y-auto scrollbar-thin pr-2 scrollbar-thumb-slate-300">
                        {activePrompt?.availableTags.map(tag => (
                            <div key={tag} className="flex flex-col gap-1 p-3 border rounded bg-[#3066bb]/5 border-[#3066bb]/20">
