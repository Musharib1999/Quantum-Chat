...
export default function ExecuteNode({ id, data }: NodeProps) {
  ...
  const onExecute = () => {
      alert("Execution initialized. Submitting pipeline to Quantum Guru backend...");
  }
  ...
  return (
    ...
    >
      ...
      <button 
        onClick={onExecute}
        className="w-full py-3 bg-[oklch(0.623_0.214_259.815)] hover:bg-[oklch(0.55_0.2_260)] text-white rounded-xl flex items-center justify-center gap-2 font-bold text-sm transition-all shadow-md active:scale-95"
      >
