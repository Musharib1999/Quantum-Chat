        ...
        <div className="flex flex-col h-full">
            <div className="p-4 border-b border-border space-y-4">
                <h3 className="font-bold text-foreground flex items-center gap-2">
                    <BookOpen className="text-zinc-400" size={18} /> Research Lab
                </h3>

                <div className="relative">
                    <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground w-4 h-4" />
                    <input
                        className="w-full bg-secondary/30 border border-border rounded-lg pl-9 pr-3 py-2 text-sm text-foreground focus:outline-none focus:border-white/20 transition-colors"
                ...
                {loading ? (
                    ...
                    >
                        <div className="flex items-start gap-3">
                            <FileText size={16} className={`shrink-0 mt-0.5 ${activeArticleId === article._id ? 'text-white' : 'text-muted-foreground/50'}`} />
                                ...
                                <div className="flex items-center gap-2 mt-1.5">
                                    ...
                                    {article.url && (
                                        <a href={article.url} target="_blank" rel="noopener noreferrer"
                                            ...
                                            className="text-[10px] opacity-50 flex items-center gap-0.5 hover:text-white hover:opacity-100 transition-opacity">
