...
const FeatureCard = ({ icon, title, description, actionText, isDarkMode, accentColor }: FeatureCardProps) => {
    ...
    return (
        <div className={`group relative p-8 rounded-3xl border transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 overflow-hidden flex flex-col justify-between h-full
      ${isDarkMode
