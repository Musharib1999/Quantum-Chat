...
Phrasing Rules:
- If the problem is feasible, use "No obvious contradiction detected." as part of your reasoning_trace instead of asserting that constraints definitely do not exceed capacity (since a formal proof is not run).
