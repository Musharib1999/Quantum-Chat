    ...
    for attempt in range(max_retries + 1):
        try:
            ...
            if attempt < max_retries:
                ...
                attempt_output = await call_fn(system=system, user=corrective_user, temperature=0.1, max_tokens=max_tokens, user_id=user_id)
            ...
            if attempt < max_retries:
                ...
                attempt_output = await call_fn(system=system, user=corrective_user, temperature=0.05, max_tokens=max_tokens, user_id=user_id)
