"""
QuantumGuru Engine v3 — Main FastAPI Server
Exposes /v3/pipeline (Scenario 1: Business Problem → Solver Code)
...
from v3.pipelines.optimization import run_optimization_pipeline
from v3.retriever import VectorRetriever

# =========================================================================
# APP SETUP
# =========================================================================
app = FastAPI(
    title="QuantumGuru Engine v3-GROQ",
    description=(
...
def root():
    return {
        "status": "QuantumGuru Engine v3-GROQ Running",
        "version": "2.0.0-GROQ",
...
async def finalize_results(request: FinalizeRequest):
    ...
    try:
        from v3.validators.json_schema import parse_and_validate
        from v3.qwen_client import call_qwen
        import json
...
async def enterprise_analyze(request: AnalyzeRequest):
    ...
    try:
        from v3.prompts import nlp_parser as nlp_prompt
        from v3.prompts import reasoner as reasoner_prompt
        from v3.validators.json_schema import parse_and_validate, validate_nlp_parser, validate_reasoner
        from v3.qwen_client import call_qwen
        ...
        from v3.llama_client import call_adapter
        from v2 import config
        import os
...
if __name__ == "__main__":
    ...
    print(f"\nQuantumGuru Engine v3 starting on port {port}")
