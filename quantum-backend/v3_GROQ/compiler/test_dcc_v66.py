...
from v3.compiler.dcc import compile_v66
...
def test_latex_rendering():
    from v3.compiler.ir import Constant, VarRef, BinaryOp, Aggregate, Constraint, ConstraintType
...
def test_sandboxed_verifier():
    from v3.compiler.ir import Variable, Domain, OptimizationIR
    from v3.compiler.dcc import SandboxedVerifier, compile_v66
