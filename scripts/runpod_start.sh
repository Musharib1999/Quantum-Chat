...
nohup vllm serve /workspace/Qwen-32B-FP8   --served-model-name predibase/Qwen2.5-32B-Instruct-FP8   --dtype auto   --max-model-len 8192   --gpu-memory-utilization 0.90   --tensor-parallel-size 1   --port 8000 > /root/vllm.log 2>&1 &
